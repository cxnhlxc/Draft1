...
# img4 = get_img_as_base64(os.path.join('images', "side.png"))
...
"""
    ...
    #st.markdown('<span style="font-family: Arial; font-size: 16px;">Age Range</span>', unsafe_allow_html=True)
...
# """ Add Dropdowns for Columns """
    ...
    # """ Add New Tabs """
    tab0, tab2, tab3 = st.tabs(['REVENUE', "CUSTOMER TREND", "TRANSPORTATION/ACCOMODATION"])
    ...
    with tab0:
        ...
        with col1:
            ...
            fig.update_layout(title= {'text':'','font':{'family':'SVN-Gilroy','size':20}},xaxis=dict(title="Leave Day",title_font=dict(family="SVN-Gilroy",size=14)),yaxis=dict(title="Revenue",title_font=dict(family="SVN-Gilroy",size=14)),legend=dict(title="LEGENDS",title_font=dict(family="SVN-Gilroy",size=14),font=dict(family="SVN-Gilroy",size=14)),font=dict(family="SVN-Gilroy",size=14),paper_bgcolor='rgba(255, 255, 255, 0)', plot_bgcolor='rgba(255, 255, 255, 0)', width=930, height=620)
        ...
        with col2:
            ...
            fig.update_layout(showlegend=True,title= {'text':'','font':{'family':'SVN-Gilroy','size':20}},xaxis=dict(title="",title_font=dict(family="SVN-Gilroy",size=14)),yaxis=dict(title="",title_font=dict(family="SVN-Gilroy",size=14)),legend=dict(title="LEGENDS",title_font=dict(family="SVN-Gilroy",size=14),font=dict(family="SVN-Gilroy",size=14)),font=dict(family="SVN-Gilroy",size=14),paper_bgcolor='rgba(255, 255, 255, 0)')
    ...
    # )
    #         fig.update_layout(title= {'text':'','font':{'family':'SVN-Gilroy','size':20}},xaxis=dict(title="AGE",title_font=dict(family="SVN-Gilroy",size=14)),yaxis=dict(title="",title_font=dict(family="SVN-Gilroy",size=14)),legend=dict(title="GENDER",title_font=dict(family="SVN-Gilroy",size=14),font=dict(family="SVN-Gilroy",size=14)),font=dict(family="SVN-Gilroy",size=14),paper_bgcolor='rgba(255, 255, 255, 0)',plot_bgcolor='rgba(255, 255, 255, 0)', width=930, height=620)
    ...
    #         st.markdown('<span style="font-family: SVN-Gilroy; font-size: 20px; font-weight: bold;">FUNNEL CHART ILLUSTRATES THE NUMBER OF CUSTOMERS USING THE SERVICE</span>', unsafe_allow_html=True)
            small_data = df[['DepartureMonthString','Gender']]
            print(small_data)

            gg = small_data.groupby(['DepartureMonthString', 'Gender']).size().reset_index(name='count')
            print(gg)


            fig = px.bar(gg,x="DepartureMonthString", y="count", color="Gender", width=930, height=620, text_auto= True, color_discrete_sequence=['rgb(210, 83, 128)', 'rgb(224, 142, 109)'], category_orders={"SMT": ["January", "February", "March", "April","May","June","July","August","September","October","November","December"]})
            fig.update_traces(marker_line_color='rgb(0,0,0)', marker_line_width=1.5, opacity=0.7)
            fig.update_layout(title= {'text':'','font':{'family':'SVN-Gilroy','size':20}},xaxis=dict(title="<b>MONTHS</b>",title_font=dict(family="SVN-Gilroy",size=14)),yaxis=dict(title="<b>NUMBER OF VISITORS</b>",title_font=dict(family="SVN-Gilroy",size=14)),legend=dict(title="<b>GENDER</b>",title_font=dict(family="SVN-Gilroy",size=14),font=dict(family="SVN-Gilroy",size=14)),font=dict(family="SVN-Gilroy",size=14),plot_bgcolor='rgba(255,255,255,0)',paper_bgcolor='rgba(255,255,255,0)')
            st.plotly_chart(fig)
            st.markdown('<span style="font-family: SVN-Gilroy; font-size: 20px; font-weight: bold;">VISITORS GOING VACATIONS EACH MONTH BY GENDER</span>', unsafe_allow_html=True)
        ...
        with col2:
            ...
            fig.update_layout(title= {'text':'','font':{'family':'SVN-Gilroy','size':20}},legend=dict(title="GENDER",title_font=dict(family="SVN-Gilroy",size=14),font=dict(family="SVN-Gilroy",size=14)),font=dict(family="SVN-Gilroy",size=14),paper_bgcolor='rgba(255, 255, 255, 0)', width=930, height=620)
            st.plotly_chart(fig)
    ...
    with tab3:
        ...
        with col1:
            ...
            # fig.update_layout(title= {'text':'','font':{'family':'SVN-Gilroy','size':20}},legend=dict(title="Transportation Type",title_font=dict(family="SVN-Gilroy",size=14),font=dict(family="SVN-Gilroy",size=13)),font=dict(family="SVN-Gilroy",size=14),paper_bgcolor='rgba(255, 255, 255, 0)')
            # st.plotly_chart(fig)
            ...
            fig.update_layout(title= {'text':'','font':{'family':'SVN-Gilroy','size':20}},xaxis=dict(title="<b>TYPES OF ACCOMMODATION</b>",title_font=dict(family="SVN-Gilroy",size=14)),yaxis=dict(title="<b>COST OF ACCOMMODATION</b>",title_font=dict(family="SVN-Gilroy",size=14)),legend=dict(title="<b>GENDER</b>",title_font=dict(family="SVN-Gilroy",size=14),font=dict(family="SVN-Gilroy",size=14)),font=dict(family="SVN-Gilroy",size=14),paper_bgcolor='rgba(255, 255, 255, 0)',plot_bgcolor='rgba(255, 255, 255, 0.1)')
        ...
        with col2:
            ...
            # fig.update_traces(marker_line_color='rgb(0,0,0)', marker_line_width=1.5, opacity=0.8)
            # fig.update_layout(title= {'text':'','font':{'family':'SVN-Gilroy','size':20}},legend=dict(title="Accommodation Type",title_font=dict(family="SVN-Gilroy",size=14),font=dict(family="SVN-Gilroy",size=13)),font=dict(family="SVN-Gilroy",size=14),paper_bgcolor='rgba(255, 255, 255, 0)')
            ...
            fig.update_layout(title= {'text':'','font':{'family':'SVN-Gilroy','size':20}},xaxis=dict(title="<b>TYPES OF TRANSPORTATION</b>",title_font=dict(family="SVN-Gilroy", size=14)),yaxis=dict(title="<b>COST OF TRANSPORTATION</b>",title_font=dict(family="SVN-Gilroy",size=14)),legend=dict(title="GENDER",title_font=dict(family="SVN-Gilroy", size=14),font=dict(family="SVN-Gilroy",size=14)),font=dict(family="SVN-Gilroy",size=14),paper_bgcolor='rgba(255, 255, 255, 0)',plot_bgcolor='rgba(255, 255, 255, 0.1)')
            fig.update_traces(showlegend=False)
            st.plotly_chart(fig)
