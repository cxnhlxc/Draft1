...
# """ Add Dropdowns for Columns """
    ...
    with tab0:
        ...
        with col2:
            ...
            fig.update_layout(showlegend=True,
                              ...
                              width=600, height=500, paper_bgcolor='rgba(255, 255, 255, 0)', plot_bgcolor='rgba(255, 255, 255, 0)')
    ...
    with tab3:
        ...
        col1, col2= st.columns([0.54, 0.46], gap="small")
        with col1:
            fig = px.box(df, x='AccommodationType', y='AccommodationCost', color='AccommodationType', color_discrete_sequence=px.colors.qualitative.Prism, width=500, height=500)
            fig.update_layout(title= {'text':'','font':{'family':'SVN-Gilroy','size':20}},
